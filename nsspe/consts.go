...
const (
	DIRECTORY_TYPE_ICONS               = 3
	DIRECTORY_TYPE_ICON_GROUPS         = 14
	DIRECTORY_TYPE_VERSION_INFO        = 16
	DIRECTORY_TYPE_CONFIGURATION_FILES = 24
)

const (
	ALIGNMENT_STANDARD_VALUE = 0x200
)

const (
	SIZE_WIN_CERTIFICATE_HDR = 8
)
...
const (
	...
	OPTIONAL_HEADER_MAGIC_ROM_HDR OptionalHeaderMagic = 0x107
)
